using EvoCommsWeb.WebPanel.Server.Terminals.ZK;
using EvoCommsWeb.WebPanel.Server.Terminals.ZK.Requests;
using Microsoft.AspNetCore.Mvc;
using Microsoft.Extensions.Primitives;

namespace EvoCommsWeb.WebPanel.Server.Controllers.ZKTeco;
    ...
    : ControllerBase
{
    ...
    public async Task<IActionResult> HandleInitialConnection([FromQuery] ZkConnectionRequest request)
    {
        try
        {
            ...
            string? serialNumber = Request.Query["SN"].ToString();
            ...
            string? response = zkService.HandleInitialConnectionAsync(serialNumber);
