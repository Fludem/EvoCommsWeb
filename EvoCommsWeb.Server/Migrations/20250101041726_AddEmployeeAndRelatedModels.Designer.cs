...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EvoCommsWeb.Server.Database.Models.Clocking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EvoCommsWeb.Server.Database.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EvoCommsWeb.Server.Database.Models.EmployeeTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EvoCommsWeb.Server.Database.Models.Terminal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EvoCommsWeb.Server.Database.Models.Clocking", b =>
                {
                    b.HasOne("EvoCommsWeb.Server.Database.Models.Employee", "Employee")
                        .WithMany("Clockings")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EvoCommsWeb.Server.Database.Models.Terminal", "Terminal")
                        .WithMany("Clockings")
            ...
            modelBuilder.Entity("EvoCommsWeb.Server.Database.Models.EmployeeTemplate", b =>
                {
                    b.HasOne("EvoCommsWeb.Server.Database.Models.Terminal", "ReceivedFrom")
